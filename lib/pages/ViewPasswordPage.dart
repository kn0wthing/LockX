...
class _ViewPasswordState extends State<ViewPassword> {
  ...
  decryptPass(String encryptedPass, String masterPass) async{
    var orginalMasterPass = await getMasterPass();
    if(orginalMasterPass != masterPass){
      setState(() {
        decrypted = "Wrong Master Password";
      });
      return;
    }
    String keyString = mainKey;
