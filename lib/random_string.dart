...
String randomAlphaNumeric(int length) {
  ...
  var string = randomMerge(alpha, numeric);
  return randomFinal(string);
}
...
String randomFinal(String string) {
  var rand = new Random();
  print(string);
  var len = string.length;
  int i = ((len - 1) * rand.nextDouble()).toInt() + 1;
  string = string.substring(0, i) + specialChars[i] + string.substring(i, len);
  print(string);
  return string;
}
